...
<?php
  if (isset($_POST['borrowBookBtn'])) {
    $penalty = addRecord(array(0), array('amount'), 'penalties');

    $books = addRecord(array($_POST['userId'],$_POST['bookId'],'pending',$penalty), 
    array('user_id','book_id','status','penalty_id'), 'reservations');
