...
<?php
  if (isset($_POST['addTeacherBtn'])) {
    ...
    array('id_number','email','first_name','middle_name','last_name','contact_number','department'), 'teachers', array($_POST['emailAddress'], $_POST['idNumber']));
  ...
  $teacherList = getRecords('teachers');
?>
<!-- end Modal -->
