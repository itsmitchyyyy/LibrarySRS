        ...
        <form method="post">
            <div class="card-body">
                ...
                <div class="form-group my-1">
                    ...
                    <input type="text"  value="<?php echo $_SESSION['user']['course']; ?>" name="course" class="form-control" id="courseInput" aria-describedby="courseHelp">
                </div>
                <hr />
                <div class="form-group my-1">
...
<?php
  if (isset($_POST['updateProfile'])) {
    ...
    $_SESSION['user'] = getStudent($_SESSION['user']['userId']);
    if ($profile) {
